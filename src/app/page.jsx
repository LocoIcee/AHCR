      ...
      <section className="bg-offwhite py-16">
        <div className="flex flex-col md:flex-row items-center justify-center gap-x-2 gap-y-4 py-10">
          ...
          <div className="flex flex-col gap-2 items-end">
            <img src="images/siteDogs/Alaska.jpg" alt="Dog 1" className="w-48 h-48 rounded-full object-cover shadow-md" />
            <img src="images/siteDogs/Chai.jpg" alt="Dog 2" className="w-48 h-48 rounded-full object-cover shadow-md relative -left-10 -mt-10 -mb-10 z-10" />
            <img src="images/siteDogs/Florence.jpg" alt="Dog 3" className="w-48 h-48 rounded-full object-cover shadow-md relative z-20" />
          </div>
          ...
          <div className="flex flex-col gap-2 items-start">
            <img src="images/siteDogs/Felix.jpg" alt="Dog 4" className="w-48 h-48 rounded-full object-cover shadow-md" />
            <img src="images/siteDogs/Alpha.jpg" alt="Dog 5" className="w-48 h-48 rounded-full object-cover shadow-md relative left-10 -mt-10 -mb-10 z-10" />
            <img src="images/siteDogs/Freedom.jpg" alt="Dog 6" className="w-48 h-48 rounded-full object-cover shadow-md relative z-20" />
          </div>
        </div>
      </section>
